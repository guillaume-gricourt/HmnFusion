...
def write(filename, name, g):
    ...
    for n in nodes:
        ...
        values += [':'.join([str(x) for x in ['./.', g.graph.nodes[n]['fusion'].evidence.get_vaf(), g.graph.nodes[n]['fusion'].evidence.depth, g.graph.nodes[n]['fusion'].evidence.get_sum(), g.graph.nodes[n]['fusion'].evidence.split, g.graph.nodes[n]['fusion'].evidence.mate, g.graph.nodes[n]['fusion'].evidence.clipped]])]

...
class TestGraph(unittest.TestCase):
    ...
    def helper_check_quanti(self, g, n_nodes, n_edges, n_lev0, n_lev1, n_lev2):
        ...
        self.assertEqual(
            len([x for x in g.graph.nodes if g.graph.nodes[x]['level'] == 0]),
            n_lev0
        )

        self.assertEqual(
            len([x for x in g.graph.nodes if g.graph.nodes[x]['level'] == 1]),
            n_lev1
        )
        self.assertEqual(
            len([x for x in g.graph.nodes if g.graph.nodes[x]['level'] == 2]),
            n_lev2
        )
    ...
    def helper_check_quali(self, g, cons_lev1=[], cons_lev2=[]):
        ...
        th_lev1 = set(
            ...
            for x in g.graph.nodes if g.graph.nodes[x]['level'] == 1
        )
        cons_lev2 = set(cons_lev2)
        th_lev2 = set(
            g.graph.nodes[x]['fusion']
            for x in g.graph.nodes if g.graph.nodes[x]['level'] == 2
        )
    ...
    def helper_check_interest(self, g, n_lev0, n_lev1, n_lev2, fusions):
        ...
        self.assertEqual(
            len(
                [
                    x for x in g.graph.nodes
                    if g.graph.nodes[x]['level'] == 0 and
                    g.graph.nodes[x]['is_interest']
                ]
            ),
            n_lev0
        )
        self.assertEqual(
            len(
                [
                    x for x in g.graph.nodes
                    if g.graph.nodes[x]['level'] == 1 and
                    g.graph.nodes[x]['is_interest']
                ]
            ),
            n_lev1
        ...
        self.assertEqual(
            len(
                [
                    x for x in g.graph.nodes
                    if g.graph.nodes[x]['level'] == 2 and
                    g.graph.nodes[x]['is_interest']
                ]
            ),
            n_lev2
        ...
        th_fusions = set(
            g.graph.nodes[x]['fusion']
            for x in g.graph.nodes if g.graph.nodes[x]['is_interest']
        )
    ...
    def test_update_graph_metadata(self):
        ...
        self.g1.update_graph_metadata(
            {'consensus_interval': 100, 'test': True}
        )
    ...
    def test_add_node(self):
        ...
        self.assertTrue(
            self.f1g in [
                self.g2ag.graph.nodes[x]['fusion']
                for x in self.g2ag.graph.nodes
            ]
        )
        self.assertFalse(
            self.f9g in [
        ...
        self.assertTrue(
            self.f3g in [
                self.g4ag.graph.nodes[x]['fusion']
                for x in self.g4ag.graph.nodes
            ]
        )
        self.assertFalse(
            self.f9g in [
    ...
    def test_consensus(self):
        ...
        self.helper_check_quali(
            self.g4bgl,
            [self.f4g, self.f6g, self.f4l, self.f6l]
        )
        ...
        self.helper_check_quali(
            self.g4egl,
            [],
            [self.f6g, self.f7g, self.f8g, self.f9g]
        )
    ...
    def test_label_build_from(self):
        ...
        self.assertEqual(
            self.g4cgl.label_build_from(9),
            ['GEN_2', 'GEN_3', 'GEN_4']
        )
        self.assertEqual(
            self.g4cgl.label_build_from(10),
            ['LUM_6', 'LUM_7', 'LUM_8']
        )
        self.assertEqual(
            self.g4cgl.label_build_from(11),
            ['HMN_10', 'HMN_9']
        )
        self.assertEqual(
            self.g4cgl.label_build_from(12),
            ['GEN_1', 'LUM_5']
        )
    ...
    def test_get_name_fusion(self):
        ...
        self.assertEqual(
            self.g4cgl.graph.nodes[1]['fusion'].get_name(),
            'GEN_1'
        )
        self.assertEqual(
            self.g4cgl.graph.nodes[2]['fusion'].get_name(),
            'GEN_2'
        )
        self.assertEqual(
            self.g4cgl.graph.nodes[3]['fusion'].get_name(),
            'GEN_3'
        )
        self.assertEqual(
            self.g4cgl.graph.nodes[4]['fusion'].get_name(),
            'GEN_4'
        )
        self.assertEqual(
            self.g4cgl.graph.nodes[5]['fusion'].get_name(),
            'LUM_5'
        )
        self.assertEqual(
            self.g4cgl.graph.nodes[6]['fusion'].get_name(),
            'LUM_6'
        )
        self.assertEqual(
            self.g4cgl.graph.nodes[7]['fusion'].get_name(),
            'LUM_7'
        )
        self.assertEqual(
            self.g4cgl.graph.nodes[8]['fusion'].get_name(),
            'LUM_8'
        )
        self.assertEqual(
            self.g4cgl.graph.nodes[9]['fusion'].get_name(),
            'HMN_9'
        )
        self.assertEqual(
            self.g4cgl.graph.nodes[10]['fusion'].get_name(),
            'HMN_10'
        )
        self.assertEqual(
            self.g4cgl.graph.nodes[11]['fusion'].get_name(),
            'HMN_11'
        )
        self.assertEqual(
            self.g4cgl.graph.nodes[12]['fusion'].get_name(),
            'HMN_12'
        )

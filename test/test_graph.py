...
class TestGraph(unittest.TestCase):
    ...
    def setUp(self):
        """Initialize objects"""
        # Evidence. 
        self.e1 = dict(raw=0, split=0, mate=0, clipped=0, depth=0) # 0
        self.e2 = dict(raw=3, split=10, mate=10, clipped=10, depth=100) # 30
        self.e3 = dict(raw=6, split=50, mate=0, clipped=10, depth=200) # 60
        self.e4 = dict(raw=30, split=100, mate=100, clipped=100, depth=300) # 300
        self.e5 = dict(raw=50, split=200, mate=200, clipped=100, depth=1000) # 500
        self.e6 = dict(raw=60, split=350, mate=150, clipped=100, depth=1000) # 600
        self.e7 = dict(raw=70, split=100, mate=300, clipped=300, depth=1000) # 700
        self.e8 = dict(raw=80, split=200, mate=250, clipped=350, depth=1000) # 800
        self.e9 = dict(raw=90, split=500, mate=300, clipped=100, depth=1000) # 900
        # Region.
        self.r1 = dict(chrom='chr9', orientation='left', position=500) # Cons
        ...
        self.r9 = dict(chrom='chr10', orientation='left', position=400) # Cons
        ...
        self.r13 = dict(chrom='chr10', orientation='right', position=4000) # Alone
        ...
        self.r19 = dict(chrom='chr10', orientation='left', position=400) # Same chr
        self.r20 = dict(chrom='chr10', orientation='right', position=6000)

        # Fusion.
        self.f1 = Fusion()
        self.f10g = Fusion.from_dict(dict(first=self.r19, second=self.r20, evidence=self.e2, software='genefuse')) # Same chr
        self.f10l = Fusion.from_dict(dict(first=self.r20, second=self.r19, evidence=self.e4, software='lumpy'))

        self.f1g = Fusion.from_dict(dict(first=self.r1, second=self.r2, evidence=self.e2, software='genefuse')) # Cons
        self.f2g = Fusion.from_dict(dict(first=self.r3, second=self.r4, evidence=self.e3, software='genefuse'))
        self.f3g = Fusion.from_dict(dict(first=self.r6, second=self.r5, evidence=self.e6, software='genefuse'))
        self.f4g = Fusion.from_dict(dict(first=self.r7, second=self.r8, evidence=self.e5, software='genefuse'))
        self.f5g = Fusion.from_dict(dict(first=self.r9, second=self.r10, evidence=self.e6, software='genefuse')) 
        self.f6g = Fusion.from_dict(dict(first=self.r12, second=self.r11, evidence=self.e8, software='genefuse')) # Alone
        self.f7g = Fusion.from_dict(dict(first=self.r13, second=self.r14, evidence=self.e7, software='genefuse'))
        self.f8g = Fusion.from_dict(dict(first=self.r15, second=self.r16, evidence=self.e9, software='genefuse'))
        self.f9g = Fusion.from_dict(dict(first=self.r18, second=self.r17, evidence=self.e5, software='genefuse'))

        self.f1l = Fusion.from_dict(dict(first=self.r1, second=self.r2, evidence=self.e2, software='lumpy')) # Cons
        self.f2l = Fusion.from_dict(dict(first=self.r3, second=self.r4, evidence=self.e3, software='lumpy'))
        self.f3l = Fusion.from_dict(dict(first=self.r6, second=self.r5, evidence=self.e6, software='lumpy'))
        self.f4l = Fusion.from_dict(dict(first=self.r7, second=self.r8, evidence=self.e5, software='lumpy'))
        self.f5l = Fusion.from_dict(dict(first=self.r9, second=self.r10, evidence=self.e6, software='lumpy')) 
        self.f6l = Fusion.from_dict(dict(first=self.r12, second=self.r11, evidence=self.e8, software='lumpy')) # Alone
        self.f7l = Fusion.from_dict(dict(first=self.r13, second=self.r14, evidence=self.e7, software='lumpy'))
        self.f8l = Fusion.from_dict(dict(first=self.r15, second=self.r16, evidence=self.e9, software='lumpy'))
        self.f9l = Fusion.from_dict(dict(first=self.r18, second=self.r17, evidence=self.e9, software='lumpy'))
        ...
        self.g4ag, self.g4bg, self.g4cg, self.g4dg, self.g4eg = Graph(), Graph(), Graph(), Graph(), Graph()
        ...
        self.gg = [self.g1ag, self.g2ag, self.g2bg, self.g3ag, self.g3bg, self.g3cg, self.g4ag, self.g4bg, self.g4cg, self.g4dg, self.g4eg]
        ...
        self.g4al, self.g4bl, self.g4cl, self.g4dl, self.g4el = Graph(), Graph(), Graph(), Graph(), Graph()
        ...
        self.gl = [self.g1al, self.g2al, self.g2bl, self.g3al, self.g3bl, self.g3cl, self.g4al, self.g4bl, self.g4cl, self.g4dl, self.g4el]
        ...
        self.g3agl.add_nodes([self.f1g, self.f7g, self.f8g, self.f1l, self.f7l, self.f8l])
        self.g3bgl.add_nodes([self.f7g, self.f3g, self.f4g, self.f7l, self.f3l, self.f4l])
        self.g3cgl.add_nodes([self.f2g, self.f3g, self.f4g, self.f2l, self.f3l, self.f4l])
        self.g4agl, self.g4bgl, self.g4cgl, self.g4dgl, self.g4egl = Graph(), Graph(), Graph(), Graph(), Graph()
        self.g4agl.add_nodes([self.f3g, self.f4g, self.f7g, self.f8g, self.f3l, self.f4l, self.f7l, self.f8l])
        self.g4bgl.add_nodes([self.f1g, self.f6g, self.f4g, self.f5g, self.f1l, self.f6l, self.f4l, self.f5l])
        self.g4cgl.add_nodes([self.f6g, self.f2g, self.f3g, self.f4g, self.f6l, self.f2l, self.f3l, self.f4l])
        self.g4dgl.add_nodes([self.f1g, self.f2g, self.f3g, self.f4g, self.f1l, self.f2l, self.f3l, self.f4l])
        self.g4egl.add_nodes([self.f6g, self.f7g, self.f8g, self.f9g, self.f6l, self.f7l, self.f8l, self.f9l])
        self.ggl = [self.g1agl, self.g2agl, self.g2bgl, self.g3agl, self.g3bgl, self.g3cgl, self.g4agl, self.g4bgl, self.g4cgl, self.g4dgl, self.g4egl]

        # Build graph genefuse-lumpy.
        self.g1at = Graph()
        self.g1at.add_nodes([self.f6g, self.f7g, self.f8g, self.f9g, self.f6l, self.f7l, self.f8l, self.f9l, self.f10g, self.f10l])
        self.gt = [self.g1at]
    ...
    def helper_check_quanti(self, g, n_nodes, n_edges, n_lev0, n_lev1, n_lev2):
        ...
        self.assertEqual(len([x for x in g.graph.nodes if g.graph.nodes[x]['level'] == 0]), n_lev0)
        self.assertEqual(len([x for x in g.graph.nodes if g.graph.nodes[x]['level'] == 1]), n_lev1)
        self.assertEqual(len([x for x in g.graph.nodes if g.graph.nodes[x]['level'] == 2]), n_lev2)

    def helper_check_quali(self, g, cons_lev1=[], cons_lev2=[]):
        cons_lev1 = set(cons_lev1)
        th_lev1 = set(g.graph.nodes[x]['fusion'] for x in g.graph.nodes if g.graph.nodes[x]['level'] == 1)
        cons_lev2 = set(cons_lev2)
        th_lev2 = set(g.graph.nodes[x]['fusion'] for x in g.graph.nodes if g.graph.nodes[x]['level'] == 2)
    ...
    def helper_check_interest(self, g, n_lev0, n_lev1, n_lev2, fusions):
        """Helper fuction for test_consensus"""
        self.assertEqual(len([x for x in g.graph.nodes if g.graph.nodes[x]['level'] == 0 and g.graph.nodes[x]['is_interest']]), n_lev0)
        self.assertEqual(len([x for x in g.graph.nodes if g.graph.nodes[x]['level'] == 1 and g.graph.nodes[x]['is_interest']]), n_lev1)
        self.assertEqual(len([x for x in g.graph.nodes if g.graph.nodes[x]['level'] == 2 and g.graph.nodes[x]['is_interest']]), n_lev2)
        fusions = set(fusions)
        th_fusions = set(g.graph.nodes[x]['fusion'] for x in g.graph.nodes if g.graph.nodes[x]['is_interest'])
    ...
    def test_add_node(self):
        ...
        self.assertTrue(self.f1g in [self.g2ag.graph.nodes[x]['fusion'] for x in self.g2ag.graph.nodes])
        self.assertFalse(self.f9g in [self.g2ag.graph.nodes[x]['fusion'] for x in self.g2ag.graph.nodes])
        self.assertEqual(self.g4ag.node_number, 4)
        self.assertTrue(self.f3g in [self.g4ag.graph.nodes[x]['fusion'] for x in self.g4ag.graph.nodes])
        self.assertFalse(self.f9g in [self.g4ag.graph.nodes[x]['fusion'] for x in self.g4ag.graph.nodes])
    ...
    def test_consensus(self):
        ...
        self.helper_check_quanti(self.g3ag, 3, 0, 3, 0, 0), self.helper_check_quanti(self.g3bg, 4, 2, 3, 1, 0), self.helper_check_quanti(self.g3cg, 4, 3, 3, 1, 0)
        self.helper_check_quanti(self.g4ag, 5, 2, 4, 1, 0), self.helper_check_quanti(self.g4bg, 6, 4, 4, 2, 0), self.helper_check_quanti(self.g4cg, 5, 3, 4, 1, 0)
        self.helper_check_quanti(self.g4dg, 5, 4, 4, 1, 0), self.helper_check_quanti(self.g4eg, 4, 0, 4, 0, 0)
        ...
        self.helper_check_quanti(self.g3al, 3, 0, 3, 0, 0), self.helper_check_quanti(self.g3bl, 4, 2, 3, 1, 0), self.helper_check_quanti(self.g3cl, 4, 3, 3, 1, 0)
        self.helper_check_quanti(self.g4al, 5, 2, 4, 1, 0), self.helper_check_quanti(self.g4bl, 6, 4, 4, 2, 0), self.helper_check_quanti(self.g4cl, 5, 3, 4, 1, 0)
        self.helper_check_quanti(self.g4dl, 5, 4, 4, 1, 0), self.helper_check_quanti(self.g4el, 4, 0, 4, 0, 0)
        ...
        self.helper_check_quanti(self.g3agl, 6, 0, 6, 0, 0), self.helper_check_quanti(self.g3bgl, 8, 4, 6, 2, 0), self.helper_check_quanti(self.g3cgl, 8, 6, 6, 2, 0)
        self.helper_check_quanti(self.g4agl, 10, 4, 8, 2, 0), self.helper_check_quanti(self.g4bgl, 12, 8, 8, 4, 0), self.helper_check_quanti(self.g4cgl, 10, 6, 8, 2, 0)
        self.helper_check_quanti(self.g4dgl, 10, 8, 8, 2, 0), self.helper_check_quanti(self.g4egl, 8, 0, 8, 0, 0)
        ...
        self.helper_check_quanti(self.g2agl, 6, 4, 4, 0, 2), self.helper_check_quanti(self.g2bgl, 7, 6, 4, 2, 1)
        self.helper_check_quanti(self.g3agl, 9, 6, 6, 0, 3), self.helper_check_quanti(self.g3bgl, 10, 8, 6, 2, 2), self.helper_check_quanti(self.g3cgl, 9, 8, 6, 2, 1)
        self.helper_check_quanti(self.g4agl, 13, 10, 8, 2, 3), self.helper_check_quanti(self.g4bgl, 14, 12, 8, 4, 2), self.helper_check_quanti(self.g4cgl, 12, 10, 8, 2, 2), self.helper_check_quanti(self.g4dgl, 11, 10, 8, 2, 1), self.helper_check_quanti(self.g4egl, 12, 8, 8, 0, 4)
        ...
        self.helper_check_quali(self.g4agl, [self.f3g, self.f3l], [self.f7g, self.f8g, self.f3g])
        self.helper_check_quali(self.g4bgl, [self.f4g, self.f6g, self.f4l, self.f6l], [self.f4g, self.f6g])
        ...
        self.helper_check_quali(self.g4egl, [], [self.f6g, self.f7g, self.f8g, self.f9g])
    ...
    def test_define_node_interest(self):
        ...
        self.helper_check_interest(self.g4eg, 4, 0, 0, [self.f6g, self.f7g, self.f8g, self.f9g])
        ...
        self.helper_check_interest(self.g4egl, 0, 0, 4, [self.f6g, self.f7g, self.f8g, self.f9g])

    def test_trim_node(self):
        """Test trim_node(self)"""
        self.helper_build_define_node_interest()
        self.helper_check_quanti(self.g1at, 14, 8, 10, 0, 4)
        self.helper_check_interest(self.g1at, 0, 0, 4, [self.f6g, self.f7g, self.f8g, self.f9g])
